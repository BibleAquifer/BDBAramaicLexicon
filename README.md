# _Brown-Driver-Briggs Aramaic Lexicon_ Aquifer Resource

This repository (`BDBAramaicLexicon`) contains Aquifer resource data with resource-level metadata, article-level metadata, and content files in JSON and Markdown formats.
...
For more information about the Aquifer platform, data, and metadata formats, visit the [Aquifer Documentation repository](https://github.com/BibleAquifer/BDBAramaicLexicon).
